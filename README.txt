This repository is for a 3D printed one handed gaming keyboard with a thumbstick and a small display. The keyboard has 36 keys and isn't meant to be used for typing but rather for gaming or other programs which don't require a full keyboard. 
